...
class MultiInputLoon:
	...
	def update(self, *args, **kwargs):
        ...
        self.__apply_accel__(ax=(a_x + f_x / m), ay=(a_y + f_y / m), az=(a_z + f_z / m))
    ...
    def __apply_pos__(self, *args, **kwargs):
        ...
        self.x = px + self.Hx_v2p.get_curr_val())
        self.y = py + self.Hy_v2p.get_curr_val())
        self.z = pz + self.Hz_v2p.get_curr_val())
